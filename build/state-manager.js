...
class StateManager {
   ...
   */
  async CreateAndFillChargeStates(vin, chargeInfo) {
   ...
   */
  async CreateAndFillCarStatus(vin, carStatus) {
   ...
   */
  async CreateAndFillMileage(vin, mileage) {
